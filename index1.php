...
<head>
    ...
    <style>
        ...
        #loader {
            ...
            width: 100%;
            height: 100vh;
            background: #21242d url('images/Logo_3.gif') no-repeat center;
            z-index: 999;
        }
    </style>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        <ul class="nav flex-column navbar-nav me-auto mb-2 mb-lg-0 deskt_menu">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link first-nav active" href="#landing">Home</a>
                                            </li>
                                        </ul>
                    ...
                    <div id="content">
                        ...
                        <main class="main " id="hscroll">
                            <div class="panel  panel2 o-scroll">
                                <div class="row">
                                    <div class="col-xxl-4 col-md-4" id="landing">
                            ...
                            <section class="text_anm intro slide--1 panel  panel4 desk_trns" id="slide-1">
                                <div class="intro__content">
                            ...
                            <section class="text_anm intro slide--1 panel  panel4 mob_trns" id="slide-1">
                                <div class="intro__content ipsGrid_span7 ipsType_right">
                                    <h2 class="intro__title gs_reveal">
                                        <!-- <line class="line1"  data-speed="5.5" data-position="top" data-module="SplittedText" data-delay="0.05">Sculpting motion,</line> -->
                                        <line class="line12">Sculpting motion,</line>
                            ...
                            <section id="Services" class="services artwork_area panel  panel6">
                            ...
                            <section class="text_anm intro slide--0 panel  panel4 desk_trns" id="slide-2">
                                <div class="intro__content">
                            ...
                            <section class="text_anm intro slide--0 panel  panel4 mob_trns" id="slide-2">
                                <div class="intro__content ipsGrid_span7 ipsType_right">
                            ...
                            <section id="contact" class=" artwork_area panel  panel7">
                                        ...
                                        <div class="col-xxl-12">
                                            <div class="form_outer">
                                                <form>
                                                    ...
                                                    <div class="mb-3">
                                                        <textarea class="form-control cnt_txt_fm" placeholder="Message" rows="3"></textarea>
                                                    </div>
                            ...
                            <section class="section panel  panel8">
                                <div class="row">
                                    <div class="col-xxl-12">
                                        <h1>
                                            <img style="height: 80vh;" src="./images/Logo.gif">
    ...
    <script>
        ...
        ScrollTrigger.matchMedia({
            "(min-width: 991px)": () => {
                ...
                ["panel2", "panel3", "panel4", "panel5", "panel6", "panel7", "panel8"].forEach((triggerClass, i) => {

                    ScrollTrigger.create({
                        trigger: '.' + triggerClass,
                        containerAnimation: scrollTween,
                        start: "left 30%",
                        end: i === 5 ? "right right" : "right 30%",
                        markers: false,

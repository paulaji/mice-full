...
<body>
								...
								<div class="container-fluid">
									...
									<div class="collapse navbar-collapse" id="navbarSupportedContent">
										<ul class="nav flex-column navbar-nav me-auto mb-2 mb-lg-0 deskt_menu">
											<li class="nav-item">
												<a class="nav-link osec" href="#Contact">Contact</a>
											</li>
											<li class="nav-item">
												<a class="nav-link osec" href="#Services">Services</a>
											</li>
											<li class="nav-item">
												<a class="nav-link osec" href="#About">About</a>
											</li>
											<li class="nav-item">
												<a class="nav-link osec" href="#Work">The Work</a>
											</li>
											<li class="nav-item">
                    ...
                    <div id="content">                      
                        ...
                        <main class="main " id="hscroll">
                                    ...
                                    <div class="col-xxl-7 col-md-7">
                                        <div class="scroll_right vd_rt">
                                            <video width="400" height="" loop="true" autoplay="autoplay" controls muted>
                                                <source src="https://miceintl.events/wp-content/uploads/2022/08/MICE-International-Wetransfer-Background.mp4?_=1" type="video/mp4">
                            ...
                            <section class="artwork_area  panel  panel3" id="Work">
                                ...
                                <div class="artwork_main scrollbar scrollable_container1" id="style-3">
                            ...
                            <section class="text_anm intro slide--0 panel  panel4 desk_trns" id="slide-0">
                                <div class="intro__content">
                                    <h2 class="intro__title intro__title_1">
                                        ...
                                        <span class="line14" id="scrollto-0">
                                            Visions become <br>
                                            tangible here.
                                        </span>
                                    </h2>
                            ...
                            <section id="About" class="panel panel5">
                                <div class="artwork_area about_area" id="">
                                    ...
                                    <div class="artwork_main artwork_main2 scrollbar about_mob scrollable_container2" id="style-3">
                                            ...
                                            <div class="row">
                                                <div class="col-xxl-8 col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="client_in">
                                                            <div class="client">
                                                                <span><img src="images/cl_1.jpg"></span>
                                                                <span><img src="images/cl_2.jpg"></span>
                                                                <span><img src="images/cl_3.jpg"></span>
                                                                <span><img src="images/cl_4.jpg"></span>
                                                                <span><img src="images/cl_5.jpg"></span>
                                                                <span><img src="images/cl_6.jpg"></span>
                                                                <span><img src="images/cl_7.jpg"></span>
                                                                <span><img src="images/cl_8.jpg"></span>
                                                                <span><img src="images/cl_9.jpg"></span>
                                                                <span><img src="images/cl_10.jpg"></span>
                                                                <span><img src="images/cl_11.jpg"></span>
                                                                <span><img src="images/cl_12.jpg"></span>
                                                                <span><img src="images/cl_13.jpg"></span>
                                                                <span><img src="images/cl_15.jpg"></span>
                                                                <span><img src="images/cl_16.jpg"></span>
                                                                <span><img src="images/cl_17.jpg"></span>
                                                                <span><img src="images/cl_19.jpg"></span>
                                                                <span><img src="images/cl_20.jpg"></span>
                                                                <span><img src="images/cl_21.jpg"></span>
                                                                <span><img src="images/cl_22.jpg"></span>
                                                                <span><img src="images/cl_23.jpg"></span>
                                                            </div>
                            ...
                            <section class="text_anm intro slide--1 panel  panel6 desk_trns" id="slide-1">
                                <div class="intro__content" id="scrollfro-1">
                                    <h2 class="intro__title intro__title_2">
                                        ...
                                        <line class="line14">move.</line>
                                        <span class="line15 trans_2" id="scrollto-1">
                                            Experiences that <br>
                                            echo dreams.
                                        </span>
                                    </h2>
                            ...
                            <section id="contact" class=" artwork_area panel  panel8">
                                ...
                                <div class="artwork_main artwork_main2 contact_main scrollbar scrollable_container3" id="style-3">
                                    ...
                                    <div class="row adds_wrap">
                                        <div class="col-xxl-12 col-md-12 adds">
            ...
            "(min-width: 991px)": () => {
              ...
              /*  document.querySelectorAll(".nav-item").forEach(link => {
                ...
                ScrollTrigger.create({
                    ...
                    onEnter: () => hideLogo('enter'),
                    onToggle: self => console.log("active", self.isActive),
                    id: "66"
                });
				$('.first-nav').on('click',function(){
					 $('#Home2').show();
					 ScrollTrigger.saveStyles(".panel2");
    ...
    */
	...
	const navLinks = gsap.utils.toArray(".nav-item a.osec");
	navLinks.forEach(link => {
	  link.addEventListener("click", e => {
		...
		e.preventDefault();
		//console.log("I am Clicking"+link.getAttribute("href"));
		$('.nav-link').removeClass('active');
		...
		const leftmenu = document.querySelector(".sidebar_wrap");
		...
		gsap.to(sections, {
				...
				x: -section.offsetLeft+100 ,
				ease: "none", // <-- IMPORTANT!
				scrollTrigger: sectionContainer,
				duration: 1.25,
			  });
	  });
	});
...
<script>
    const bodyElement = document.body; // select the whole html body
    const scrollableContainer = document.querySelector(".scrollable_container1") // select container number 1
    const scrollableContainer2 = document.querySelector(".scrollable_container2") // select container number 2
    const scrollableContainer3 = document.querySelector(".scrollable_container3") // select container number 3

    // function to find whether the end of each containers are reached
    function isAtBottom() {
        return (
        scrollableContainer.scrollTop + scrollableContainer.offsetHeight >= scrollableContainer.scrollHeight
        );
    }
    function isAtBottom2() {
        return (
        scrollableContainer2.scrollTop + scrollableContainer2.offsetHeight >= scrollableContainer2.scrollHeight
        );
    }
    function isAtBottom3() {
        return (
        scrollableContainer3.scrollTop + scrollableContainer3.offsetHeight >= scrollableContainer3.scrollHeight
        );
    }

    // event listener to skip to next section when the cursor reaches the end
    scrollableContainer.addEventListener('scroll', () => {
        if(isAtBottom()) {
            gsap.to(window, {duration: 1, scrollTo:"#scrollto-0"}); // scroll to next section
        }
    })
    scrollableContainer2.addEventListener('scroll', () => {
        if(isAtBottom2()) {
            gsap.to(window, {duration: 1, scrollTo:"#scrollto-1"}); // scroll to next section
        }
    })
    scrollableContainer3.addEventListener('scroll', () => {
        if(isAtBottom3()) {
            gsap.to(window, {duration: 0.01, scrollTo:"#scrollfro-2"}); // scroll to next section
        }
    })

    // function to find whether the top of the container is reached
    function isAtTop() {
        return (
    ...
    function isAtTop2() {
        return (
        scrollableContainer2.scrollTop == 0
        );
    }
    function isAtTop3() {
        return (
        scrollableContainer3.scrollTop == 0
        );
    }

    // event listener to skip to previous section when the cursor reaches the end
    scrollableContainer.addEventListener('scroll', () => {
        if(isAtTop()) {
            gsap.to(window, {duration: 1, scrollTo:{y: 1000}}); // just scrolling to a particular pixel position
        }
    })
    scrollableContainer2.addEventListener('scroll', () => {
        if(isAtTop2()) {
            gsap.to(window, {duration: 0.1, scrollTo:"#scrollfro-1"});
        }
    })
    scrollableContainer3.addEventListener('scroll', () => {
        if(isAtTop3()) {
            gsap.to(window, {duration: 0.1, scrollTo:"#scrollfro-2"});
        }
    })
</script>
<script>
    const contactNavElement = document.getElementById("ContactNavElement");
    const serviceNavElement = document.getElementById("ServiceNavElement");
    const aboutNavElement = document.getElementById("AboutNavElement");
    const workNavElement = document.getElementById("WorkNavElement");
    const homeNavElement = document.getElementById("HomeNavElement");
